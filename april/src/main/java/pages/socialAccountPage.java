...
public class socialAccountPage extends baseFile {
	...
	public void connectFacebook(String Emailid, String Password, String FBpage)  {	
		...
		String x = fbConnect.getCssValue("display");		
		
		if (x.equalsIgnoreCase("none"))  {	System.out.println("Account Already Connected");}
		else  {
		...
		Boolean checkCred = driver.findElements(By.xpath("//div[@class='pam login_error_box uiBoxRed']")).size() == 0;
